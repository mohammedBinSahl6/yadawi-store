  ...
  <section className="faq-ask">
    ...
    <div className="row">
      <div className="col-md-6 col-lg-4 mb-4">
        <h6 className="mb-3 ">
          <i className="far fa-paper-plane  pe-2" /> Payment methods are not included?
      ...
      <div className="col-md-6 col-lg-4 mb-4">
        <h6 className="mb-3 ">
          <h5 className="" >If I want to cancel the subscription, will I be charged a fee?</h5>
        </h6>
        <p>
          <strong>
      ...
      <div className="col-md-6 col-lg-4 mb-4">
        <h6 className="mb-3 y">
          <i className="fas fa-book-open y pe-2" /> Another question
          ...
          <div className="accordion-item mb-3">
            ...
            >
              <div className="accordion-body text-sm opacity-8">
                ...
                try. Like, one thing people can't say is that I'm not trying,
                and I'm not trying my hardest, and I'm not trying to do the best
                way I know how.
              </div>
            </div>
          </div>
