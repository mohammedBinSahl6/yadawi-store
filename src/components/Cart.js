								...
								<div className='cart-item p-3'>
									<h2 className='remove-btn'>
										<i
											...
											onClick={() => removeItem(cartP.product.product_id)}
									...
									<div className=' p-3 f-holder'>
										<div className='d-flex f-holder counter'>
											<button
												className='btn'
												onClick={() => increace(cartP.product.id)}
												disabled={cartP.count === cartP.product.qty}
											>
											...
											<button
												className='btn'
												onClick={() => decreace(cartP.product.id)}
